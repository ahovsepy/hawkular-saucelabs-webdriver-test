...
public class HawkularAlertFilterConstants {
	 ...
	 public static final By verifyDescription=By.xpath("//*[contains(text(),'JVM Heap Used')]");
	 ...
	 public static final By alertDetailPageLocator=By.xpath("//*[contains(text(),'Alert Details')]");
	 public static final By acknowledgeButton = By.xpath("//button[contains(text(),'Acknowledged')]");
	 public static final By saveButton = By.xpath("//button[contains(text(),'Save')]");
	 public static final By acknowledgeComment=By.xpath("//*[contains(text(),'Manually acknowledged')]");
	 public static final By allAlertsLink = By.linkText("« All Alerts");
	 public static final By acknowledgeStatus=By.xpath("//*[contains(text(),'Acknowledged')]");
	 public static final By resolveButton = By.xpath("//button[contains(text(),'Resolved')]");
	 public static final By resolveComment=By.xpath("//*[contains(text(),'Manually resolved')]");
//	 public static final By resolvedAlertCheckBox=By.xpath("//*[contains(text(),'Display Resolved Alerts')]");
